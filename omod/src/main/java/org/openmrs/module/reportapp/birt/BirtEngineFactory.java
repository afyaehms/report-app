...
/**
 * Spring {@link FactoryBean} for the shared, singleton instance of the
 * {@link IReportEngine report engine}. There should be one
 * {@link IReportEngine} per JVM.
 *
...
public class BirtEngineFactory implements FactoryBean<IReportEngine>,
	...
	/**
	 * Attribute under which the Spring {@link ApplicationContext application
	 * context} is exposed for BIRT reports.
	 */
	...
	public IReportEngine getObject() {
		synchronized (this.monitor) {
			...
			config.setLogConfig(
					null != this.logDirectory ? this.logDirectory
